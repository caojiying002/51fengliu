...
class RecordRepository @Inject constructor(
     ...
     * 获取单条记录详情
     * @param id 记录ID
     * @return Flow<ApiResult<RecordInfo>> 包含记录详情的结果流
     */
    fun getDetail(id: String): Flow<ApiResult<RecordInfo>> = apiCall {
     ...
     */
    fun favorite(id: String): Flow<ApiResult<NoData>> = apiCall {
     ...
     */
    fun unfavorite(id: String): Flow<ApiResult<NoData>> = apiCall {
     ...
     * 上传图片
     * @param file 要上传的文件
     * @return Flow<ApiResult<String>> 包含上传后图片URL的结果流
     */
    fun uploadImage(file: File): Flow<ApiResult<String>> = apiCall {
